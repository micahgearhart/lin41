The [rnp_enriched_transcripts.md](rnp_enriched_transcripts.md) file contains an annotated, reproducible workflow for the data presented in the following paper:
