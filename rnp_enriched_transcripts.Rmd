...
# boxplot(seq3utr$`Lin-41 IP` ~ seq3utr$taw)
 
# boxplot(seq3utr$`Oma-1 IP` ~ seq3utr$loedige)
# boxplot(seq3utr$`Lin-41 IP` ~ seq3utr$taw)
...
pA[pA$external_name %in% genes_of_interest,
   c("external_name","class","N2.tail.lengths","GLD2.tail.lengths","Fold.Change","FDR","statistic")]

#barcode plot
pA$statistic<-apply(z,1,function(x) t.test(x[1:3],x[4:6])$statistic)
